...
| 系统 | 架构 | 构建目标 | 发布文件 |
|---|---:|---|---|
| Windows | x64 | `win-x64` | `CodeXPets-v4.1.17-win-x64.exe` / `.zip` |
| Windows | ARM64 | `win-arm64` | `CodeXPets-v4.1.17-win-arm64.exe` / `.zip` |
| macOS | Intel | `osx-x64` | `CodeXPets-v4.1.17-macos-x64.zip` / `.dmg` |
| macOS | Apple Silicon | `osx-arm64` | `CodeXPets-v4.1.17-macos-arm64.zip` / `.dmg` |
